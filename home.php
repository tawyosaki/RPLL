...
<div id="Layer4" class="boxrounded2">
  <p>&nbsp;</p>
  <div align="center">
    <table width="701" height="299" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" bgcolor="#FFFFFF">
      <tr>
        <td width="257" height="43" bgcolor="#CCCCCC"><span class="style22">Title : <?php echo $row_timeline['judul']; ?></span></td>
        <td colspan="2" bgcolor="#CCCCCC"><span class="style22">Date : <?php echo $row_timeline['tgl']; ?></span></td>
      </tr>
      ...
      <tr>
        <td height="42" bordercolor="#FFFFFF" bgcolor="#CCCCCC"><span class="style22"><a href="cat/delete.php">Delete </a></span></td>
...
<div class="boxrounded12" id="Layer8">
  <p>&nbsp;</p>
  <ul>
    <li><span class="style53 style50">Update profile </span></li>
    <li class="style54"><a href="cat/catat.php">Create new diary</a></li>
    <li><span class="style54"><a href="<?php echo $logoutAction ?>">Log out</a></span></li>
  </ul>
  <p>&nbsp;</p>
</div>
</body>
